...
![Understanding file system paths: This diagram shows how an absolute path like `/home/catchen/working` is constructed by following the directory tree from root (`/`) through each level.](images/Directory_example.jpeg){#fig-paths width="70%"}
...
- **[Software Carpentry: The Unix Shell](https://swcarpentry.github.io/shell-novice/)** — An excellent interactive tutorial designed for scientists
